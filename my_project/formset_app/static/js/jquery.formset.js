 ...
 ;(function($) {
 	$.fn.formset = function(opts) {
 		...
 		insertDeleteLink = function(row) {
			...
			row.append('<td><a class="' + options.deleteCssClass + ' btn-danger delete-formset-row" href="javascript:void(0)"><i class="icon-remove icon-white"></i>' + options.deleteText +'</a></td>');
			// }
